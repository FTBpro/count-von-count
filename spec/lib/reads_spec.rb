...
describe "Read Action" do
  before :all do
    ...
    @league_weekly_leaderboard = create :LeagueWeeklyLeaderboard, { league: league_id, week: Time.now.strftime("%W"), year: Time.now.strftime("%Y") }
    @league_monthly_leaderboard = create :LeagueMonthlyLeaderboard, { league: league_id, month: Time.now.strftime("%m"), year: Time.now.strftime("%Y") }
    @team_weekly_leaderboard = create :TeamWeeklyLeaderboard, { team: team_id, week: Time.now.strftime("%W"), year: Time.now.strftime("%Y") }
    @team_monthly_leaderboard = create :TeamMonthlyLeaderboard, { team: team_id, month: Time.now.strftime("%m"), year: Time.now.strftime("%Y") }
  end
